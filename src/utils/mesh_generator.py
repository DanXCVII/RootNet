...
class MeshGenerator:
    ...
    def create_mesh(self):
        ...
        geom.extrude(disk, translation_axis=self.translation_axis, 
                     num_layers=self.num_layers, recombine=True)
        
        mesh = geom.generate_mesh()
        
        # 4. Write the mesh to a vtk and msh file
        full_path = "{}/cylinder_r_{}_d_{}_res_{}".format(self.path, self.radius, self.translation_axis[2], self.mesh_size)
